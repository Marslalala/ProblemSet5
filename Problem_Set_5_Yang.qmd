...
***https://github.com/Marslalala/ProblemSet5.git***
...
ggplot(result, aes(x = month, group = season)) +
  ...
  geom_line(aes(y = mean_temp, color = "Mean Temperature (°C)"), size = 1) +
  ...
  labs(title = "Mean Monthly Variables by Season",
       ...
       color = "Variable",
       linetype = "Variable") +
  scale_color_manual(values = c("Mean Temperature (°C)" = "black", "Mean O3" = "red",
                                "Mean PM10" = "blue", "Mean Dewpoint" = "green")) +
  theme_bw() +
  theme(legend.position = "top")
```

From the plot, we can see that the 'blue line' fluctuates the least with the change in month. We know that each piece of a line segment represents a season. Hence we know that PM10 seems to have the least seasonal trend.
...
```{r}
##' @title Return a polynomial of an object
##' @param coefficients A vector of numerical value representing the coefficient part 
##' @param exponents A vector of numerical value representing the exponent part 
##' @return The polynomial expression of the object
...
```{r}
##' @title Validator of the object 'poly'
##' @param object A 'poly' object
##' @return A boolean value to test the validity of the coefficients and exponents
...
```{r}
##' @title Return a polynomial of an object which is the result of the sum of two polynomials
##' @param e1 An equation representing a 'poly' object
##' @param e2 An equation representing a 'poly' object
##' @return The polynomial expression of the sum of two polynomials
...
```{r}
##' @title Return a polynomial of an object which is the result of the difference of two polynomials
##' @param e1 An equation representing a 'poly' object
##' @param e2 An equation representing a 'poly' object
##' @return The polynomial expression of the difference of two polynomials
setMethod("-", signature = c("poly", "poly"), function(e1, e2) {
  #  Ensure that the polynomials are valid
  validObject(e1)
  validObject(e2)
...
Get the data.table and clean the data as we only need departure and arrival delays, destination and departing airport in this case.
